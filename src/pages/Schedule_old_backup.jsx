            ...
            <div className="-mx-4 px-4 sm:mx-0 sm:px-0">
              ...
              <div className="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
                <div className="bg-gradient-to-r from-blue-500 to-blue-600 px-4 py-3 flex items-center justify-between">
                  ...
                  <div className="bg-white px-3 py-1 rounded text-blue-600 font-medium">
                    Actions ▼
                  </div>
                </div>
                  ...
                  <table className="w-full min-w-[800px]">
                    <thead>
                      <tr className="border-b-2 border-gray-200 bg-gray-50">
                        <th className="px-4 py-4 text-left text-sm font-bold text-gray-700 bg-gray-100 w-24">
                          <div className="text-center">Time</div>
                        </th>
                        {weekDates.map((date, index) => (
                          <th key={index} className="px-3 py-4 text-center bg-gray-50 min-w-32">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {timeSlots.map(time => (
                        <tr key={time} className="hover:bg-gray-50/50 transition-all duration-200">
                          <td className="px-4 py-6 text-center font-bold text-gray-700 bg-gray-50 border-r border-gray-200">
                          ...
                          {weekDates.map((date, index) => {
                            ...
                            return (
                              <td key={index} className="px-2 py-2 relative border-r border-gray-100">
                                {classItem ? (
                                  <div className={`
                                    relative rounded-lg p-3 h-20 flex flex-col justify-center border-2 shadow-sm
